...
const QUICK_CATEGORIES = [
  ...
  { id: 'recom', label: '🍽️ Platos y Especialidades' },
...
const INITIAL_MESSAGE = {
  id: 'welcome',
  sender: 'bot',
  text: '¡Pura vida! Soy Ray, tu concierge gastronómico en Donde Ray (Playa Chiquita, Puerto Viejo de Limón). ¿Cómo puedo consentirte hoy?',
  actions: [
    { label: '📅 Reservar Paso a Paso', actionId: 'asistida' },
    { label: '⚡ Consultar Aforo en Vivo', actionId: 'aforo_vivo' },
    { label: '🍽️ Platos Recomendados', actionId: 'recom' },
...
export const ChatbotConcierge = () => {
  ...
  const handleCheckLiveCapacity = async () => {
    ...
    try {
      ...
      const res = await fetch(`http://localhost:3001/reservations?date=${today}`);
    ...
    switch (intentId) {
      ...
      case 'horarios':
        addBotMessage(
          ...
          '• ☀️ Turno Almuerzo: 12:00 a 15:00\n' +
          '• 🌙 Turno Cena: 18:00 a 22:00\n\n' +
          '🔒 Lunes y Martes: Cerrado por descanso de cocina y recolección de ingredientes frescos.\n' +
          '🛡️ Aforo: Máximo 20 comensales por turno para garantizar una atención íntima y relajada.',
          [
      ...
      case 'cocteles':
        addBotMessage(
          ...
          [
            ...
            { label: '🍽️ Ver Platos para Maridar', actionId: 'recom' }
          ]
        );
        break;
      ...
      case 'comprobante':
        addBotMessage(
          '🎟️ Comprobante Digital (Voucher Ticket):\n\n' +
      ...
      case 'saludo':
        addBotMessage(
          ...
          [
            { label: '📅 Reservar Paso a Paso', actionId: 'asistida' },
            { label: '🍽️ Recomendaciones del Chef', actionId: 'recom' },
      ...
      default: {
        ...
        addBotMessage(
          ...
          [
            { label: '📅 Reservar Paso a Paso', actionId: 'asistida' },
            { label: '🍽️ Platos y Carta', actionId: 'recom' },
  ...
  const handleWizardStep = (step, val) => {
    if (step === 'guests') {
      ...
      addBotMessage(
        ...
        [
          { label: '☀️ Almuerzo · 13:00', wizardStep: 'time', val: '13:00' },
          { label: '☀️ Almuerzo · 14:00', wizardStep: 'time', val: '14:00' },
