...
function HomePage() {
	return <main>
		<section className="hero-section">
			<div className="hero-copy"><span className="eyebrow">Restaurante Caribeño · Puerto Viejo, Limón</span><h1>Lo que somos<br /><em>se sirve en la mesa.</em></h1><p className="hero-lead">Alta cocina caribeña con raíces costarricenses, pesca fresca del día y los auténticos sabores del coco, jengibre y chile panameño frente al mar.</p><div className="hero-actions"><Link className="button button--primary" to="/reservas">Reservar una mesa <span>→</span></Link><Link className="text-link" to="/menu">Explorar la carta <span>↗</span></Link></div></div>
		...
		<section className="contact-section"><span className="eyebrow">Encontrémonos</span><h2>Tu próxima mesa<br /><em>empieza aquí.</em></h2><div className="contact-row"><span>Playa Chiquita, Puerto Viejo de Talamanca, Limón</span><a href="mailto:hola@donderay.com">hola@donderay.com</a><Link className="button button--outline" to="/reservas">Reservar mesa</Link></div></section>
	</main>
}
